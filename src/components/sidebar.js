...
const DrawerWrapper = styled.div`
  ...
  transform:${props => (props.DrwVisible ? "translateX(0)" : "translateX(100%)")};   
...
.active, .link:hover{
  ...
  background: #f5f5f5;
  box-shadow: 0px 3px 8px var(--primaryColor), inset 0px 2px 3px var(--primaryColor);
}
