...
export default [
  {
    icon: <FaFacebook className={styles.bigIcon}></FaFacebook>,
    label: "facebook",
    url:
  ...
  {
    icon: <FaPinterest className={styles.bigIcon}></FaPinterest>,
    label: "pinterest",
    url: "https://www.pinterest.com/SvadbeniCvet/",
  },
  {
    icon: <FaInstagram className={styles.bigIcon}></FaInstagram>,
    label: "instagram",
    url: "https://www.instagram.com/cvetici__za__svadbu/?igshid=1bs2j1shz10z",
  },
  {
    icon: <FaYoutube className={styles.bigIcon}></FaYoutube>,
    label: "youtube",
    url:
